...
# 2. The "Noir" pipepline (100% grayscale)
transform = A.Compose([
    A.RandomRotate90(p=0.5),
    A.HorizontalFlip(p=0.5),
    
    # ⚫⚪ GRAYSCALE (30% - Higher is better for shape)
    # Removing color entirely is the ultimate test for shape.
    A.ToGray(p=1.0),
...
if __name__ == "__main__":
    print("🚀 Starting Noir (Grayscale) Augmentation...")
    ...
    # Since I have 500 originals, this adds 500 gray versions. Total = 1000.
